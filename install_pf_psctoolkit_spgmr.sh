...
# version: 2026-05-14
# 
# Installs ParFlow to test PSCToolkit (nvector) interface to test with Sundials KINSOL SPGMR
# 
# USAGE:
...
export PF_DIR=${BASE_ROOTDIR}/parflow_test_spgmr  # where parflow is downloaded
export PARFLOW_DIR=${BASE_ROOTDIR}/parflow_install_test_spgmr  # where parflow is installed
export PF_BUILD_DIR=${BASE_ROOTDIR}/parflow_build_test_spgmr
...
# download parflow
git clone -b psctoolkit-test-spgmr https://github.com/mfahdaz/parflow.git $PF_DIR
